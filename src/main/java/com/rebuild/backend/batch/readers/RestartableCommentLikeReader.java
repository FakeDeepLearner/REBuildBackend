...
@Component
public class RestartableCommentLikeReader extends AmqpItemReader<CommentLikeRequest> implements ItemStream {
    ...
    public RestartableCommentLikeReader(AmqpTemplate amqpTemplate) {
        super(amqpTemplate);
    }

...
@Component
public class RestartablePostLikeReader extends AmqpItemReader<PostLikeRequest> implements ItemStream {

    private long currentIndex = 0L;

    private static final String CURRENT = "current.index";

    public RestartablePostLikeReader(AmqpTemplate amqpTemplate) {
        super(amqpTemplate);
    }
